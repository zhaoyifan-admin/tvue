...
import { downFile } from '../../../src/utils/util.mjs';
...
var script = create({
  ...
  methods: {
    init () {
      ...
      beauty.src = this.img;
      beauty.onload = () => {
        const width = this.option.width || beauty.width;        const height = this.option.width ? ((beauty.height / beauty.width) * this.option.width) : beauty.height;
        ...
        this.list.forEach((ele, index) => {
          ...
          if (ele.img) {
            ...
            img.src = ele.img;
            img.onload = () => {
              const widths = ele.width || img.width;              const heights = ele.width ? ((img.height / img.width) * ele.width) : img.height;
