<template>
  <div v-if="boxVisible">
    <component :is="dialogType"
               ...
               :class="['tvue-dialog',b('dialog'),{'tvue-dialog--fullscreen':fullscreen}]"
               :custom-class="crud.tableOption.dialogCustomClass"
               :modal-append-to-body="vaildData(crud.tableOption.dialogModalAppendToBody,$TVUE.modalAppendToBody)"
               :append-to-body="vaildData(crud.tableOption.appendToBody,$TVUE.appendToBody)"
               :top="dialogTop"
               :title="dialogTitle"
